...
class MitsubaSceneProperties:
    ...
    def __init__(self, props):
        self.objects = OrderedDict(props)
...
class MitsubaSceneImportContext:
    ...
    def __init__(self, bl_context, bl_scene, bl_collection, mi_scene_props, axis_matrix):
    ...
    def resolve_scene_relative_path(self, path):
        ...
        return str(mi.Thread.thread().file_resolver().resolve(path))
