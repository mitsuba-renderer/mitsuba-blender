...
def test_prespective_sensor():
    import importlib
    sensors = importlib.import_module("bl_ext.user_default.mitsuba_blender.io.importer.sensors")
    assert sensors
    common = importlib.import_module("bl_ext.user_default.mitsuba_blender.io.importer.common")
    assert common
